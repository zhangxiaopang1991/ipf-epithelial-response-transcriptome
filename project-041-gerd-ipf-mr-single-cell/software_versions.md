...
The analysis was developed with R 4.6.1, Node.js 20.11.0 and the following R packages: data.table 1.18.4, MendelianRandomization 0.10.0, MRPRESSO 1.0, ieugwasr 1.1.0.9000 and ggplot2 4.0.3.
